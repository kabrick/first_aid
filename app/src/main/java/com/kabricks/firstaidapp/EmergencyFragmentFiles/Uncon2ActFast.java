 ...
 */
public class Uncon2ActFast extends Fragment {


    public Uncon2ActFast() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_uncon2_act_fast, container, false);
        ...
        String path = "android.resource://" +getActivity().getPackageName() + "/" + R.raw.uncon_breathing;
