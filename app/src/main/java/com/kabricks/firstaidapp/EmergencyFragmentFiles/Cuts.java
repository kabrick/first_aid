...
public class Cuts extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cuts, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.viewMap:
                Toast.makeText(Cuts.this, "This feature is not yet available in this app version", Toast.LENGTH_SHORT).show();
                return true;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position == 0){
                CutsActFast cutsActFast = new CutsActFast();
                return cutsActFast;
            }
            else if(position == 1){
                CutsFollowUp cutsFollowUp = new CutsFollowUp();
                return cutsFollowUp;
            }
            else{
                CutsQaA cutsQaA = new CutsQaA();
                return cutsQaA;
            }
        }
