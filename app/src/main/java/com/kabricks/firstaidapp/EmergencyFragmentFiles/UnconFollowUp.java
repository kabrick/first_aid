 ...
 */
public class UnconFollowUp extends Fragment {


    public UnconFollowUp() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_uncon_follow_up, container, false);
        ...
        String path = "android.resource://" +getActivity().getPackageName() + "/" + R.raw.metro;
