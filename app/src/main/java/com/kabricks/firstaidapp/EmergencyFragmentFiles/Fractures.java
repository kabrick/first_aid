...
public class Fractures extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_fractures, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.viewMap:
                Toast.makeText(Fractures.this, "This feature is not yet available in this app version", Toast.LENGTH_SHORT).show();
                return true;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                FracturesActFast fracturesActFast = new FracturesActFast();
                return fracturesActFast;
            } else {
                FracturesQaA fracturesQaA = new FracturesQaA();
                return fracturesQaA;
            }
        }
