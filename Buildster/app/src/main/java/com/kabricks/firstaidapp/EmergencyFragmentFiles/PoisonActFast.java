 ...
 */
public class PoisonActFast extends Fragment {


    public PoisonActFast() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_poison_act_fast, container, false);
        ...
        String path = "android.resource://" +getActivity().getPackageName() + "/" + R.raw.poison;
