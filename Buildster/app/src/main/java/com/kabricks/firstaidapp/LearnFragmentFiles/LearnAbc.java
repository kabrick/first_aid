...
public class LearnAbc extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_learn_abc, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.viewMap:
                Toast.makeText(LearnAbc.this, "This feature is not yet available in this app version", Toast.LENGTH_SHORT).show();
                return true;
    ...
    public void goForTest(View view){
        Intent intent = new Intent(LearnAbc.this, TestAbc.class);
        startActivity(intent);
    }
}
