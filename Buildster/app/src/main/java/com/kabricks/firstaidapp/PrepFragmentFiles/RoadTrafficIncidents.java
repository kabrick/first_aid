...
public class RoadTrafficIncidents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_road_traffic_incidents);

        checkBox1 = (CheckBox)findViewById(R.id.checkBox29);
        checkBox2 = (CheckBox)findViewById(R.id.checkBox36);
        checkBox3 = (CheckBox)findViewById(R.id.checkBox37);
        checkBox4 = (CheckBox)findViewById(R.id.checkBox38);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_road_traffic_incidents, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.viewMap:
                Toast.makeText(RoadTrafficIncidents.this, "This feature is not yet available in this app version", Toast.LENGTH_SHORT).show();
                return true;
