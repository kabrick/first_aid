...
public class Poison extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_poison, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.viewMap:
                Toast.makeText(Poison.this, "This feature is not yet available in this app version", Toast.LENGTH_SHORT).show();
                return true;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position == 0){
                PoisonActFast poisonActFast = new PoisonActFast();
                return poisonActFast;
            }
            else{
                PoisonQaA poisonQaA = new PoisonQaA();
                return poisonQaA;
            }
        }
